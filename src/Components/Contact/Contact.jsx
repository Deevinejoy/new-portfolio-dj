        ...
        <div className='col-xl-5 col-lg-5 col-md-5 col-sm-5'>
          <Zoom top>
            <div className="contact-form-image">
              <img src='/img/vector.jpg' alt='contact image' />



            </div>
          </Zoom>
          <div className='socials pic-socials'>
            <a href='https://github.com/Deevinejoy' target='_blank'> < BsGithub size={30} /></a>
            <a href='https://linkedin.com/Deevinejoy' target='_blank'> <BsLinkedin size={30} /></a>
            <a href='https://whatsapp.com/Deevinejoy' target='_blank'> <BsWhatsapp size={30} /></a>
          </div>
          ...
          <div className="contact-form">
            ...
            <Slide direction='right'>
              <form action="" className="contact" onSubmit={handleSubmit} >
                ...
                <div className='socials form-socials'>
                  <a href='https://github.com/Deevinejoy' target='_blank'> < BsGithub size={30} /></a>
                  <a href='https://linkedin.com/in/akinola-divine-joy-722785311' target='_blank'> <BsLinkedin size={30} /></a>
                  <a href='https://api.whatsapp.com/send?phone=2348130696012&text=Hello %2C%2OI%80%99m%20here%20from%20your%20website%20' target='_blank'> <BsWhatsapp size={30} /></a>
                </div>
